...
CSClient.prototype.createBackupRequest = function (credentials, cb) {
    ...
    var getParams = {
        ...
        data: {
            reqId: Math.random().toString(36).substr(2, 11),
...
CSClient.prototype.buildBackupData = function (credentials, backupRequest) {
    ...
    if (!this._verifyBackupRequestSignature(credentials.requestPubKey, backupRequest))
...
CSClient.prototype._verifyBackupRequestSignature = function (pubkey, backupRequest) {
